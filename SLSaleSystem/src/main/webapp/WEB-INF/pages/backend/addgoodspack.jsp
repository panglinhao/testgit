...
<div>
	<ul class="breadcrumb">
		...
		<li><a href="/SLSaleSystem/backend/addgoodspack.html">添加商品套餐</a></li>
	</ul>
</div>
			...
			<legend>添加商品套餐</legend>
                 <form action="/SLSaleSystem/backend/saveaddgoodspack.html" class="form-horizontal" enctype="multipart/form-data" method="post" onsubmit="return addGoodsPackFunc();">
...
<script type="text/javascript" src="<%=path %>/statics/localjs/addgoodspack.js"></script> 
