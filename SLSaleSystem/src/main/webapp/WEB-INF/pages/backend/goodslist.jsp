...
<body>
	...
	<form action="/SLSaleSystem/backend/goodslist.html" method="post">
		...
		<ul>
			<c:forEach items="${goodsInfoList}" var="goodsInfo">
				<li>
					...
					<label class="add" gid="${goodsInfo.id}" gname="${goodsInfo.goodsName}" rprice="${goodsInfo.realPrice}"><img src="<%=request.getContextPath() %>/statics/img/+.png" width="24px;"/></label>
