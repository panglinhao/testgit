...
<div>
	<ul class="breadcrumb">
		...
		<li><a href="/SLSaleSystem/backend/userlist.html">用户管理</a></li>
	</ul>
</div>
...
<div class="pagination pagination-centered">
  <ul>
  	...
  	<c:if test="${page.prevPages != null }">
  		...
  		<li>
  		<a href="/SLSaleSystem/backend/userlist.html?currentpage=${num }&s_loginCode=${s_loginCode }&s_referCode=${s_referCode}&s_roleId=${s_roleId}&s_isStart=${s_isStart}" title="${num }">
  		${num }</a>
  		</li>
  		</c:forEach>
  	</c:if>
...
<script type="text/javascript" src="<%=path %>/statics/localjs/userlist.js"></script>