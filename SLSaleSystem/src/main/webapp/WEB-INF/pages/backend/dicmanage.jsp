...
<div>
	<ul class="breadcrumb">
		...
		<li><a href="/SLSaleSystem/backend/dicmanage.html">数据字典管理</a></li>
	</ul>
</div>
				...
				<div class="box span12">
					...
					<div class="box-content">
						<table class="table table-striped table-bordered bootstrap-datatable datatable">
						  ...
						  <li class="addDicBtn">
						  		<img src="<%=path %>/statics/img/ico7.png"/>
						  </li>
						  <c:forEach items="${dataList}" var="dl">
						  	<li class="maintitle">
						  		...
						  		<span class="mainset">
									<img class="modifyMainDic" dictypename="${dl.typeName}" dicid="${dl.id}" dictypecode="${dl.typeCode}" src="<%=path %>/statics/img/ico10.png"> <img class="delMainDic" dictypecode="${dl.typeCode}" dictypename="${dl.typeName}" src="<%=path %>/statics/img/linkdel.png">
								</span>
						  	</li>
						  </c:forEach>
						  <li class="addDicBtn">
						  ...
						  <div class="dicListContent">
							...
							-->
						  	...
						  	<ul id="addsubdicul">
						  		<li id="addDicLiBtn" class="addDicLiBtn"><img src="<%=path %>/statics/img/winapp_add.png"/></li>
						  	</ul>
						  </div>
...
<script type="text/javascript" src="<%=path %>/statics/localjs/dicmanage.js"></script>