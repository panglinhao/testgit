...
<div>
	<ul class="breadcrumb">
		...
		<li><a href="/SLSaleSystem/backend/modifygoodspack.html">修改商品套餐</a></li>
	</ul>
</div>
			...
			<legend>修改商品套餐</legend>
                 <form action="/SLSaleSystem/backend/savemodifygoodspack.html" class="form-horizontal" enctype="multipart/form-data" method="post" onsubmit="return modifyGoodsPackFunc();">
					...
					<div class="control-group">
					  ...
					  <div class="controls">
						<ul class="aboutproductsList">
						  	<li><iframe id="goodsListFrame" class="goodsListFrame" src="/SLSaleSystem/backend/goodslist.html"></iframe></li>
						  	<li id="selectgoodslist">
						  		<c:if test="${goodsList != null}">
									...
									<label class="del" rprice="${goods.realPrice}"><img src="<%=path %>/statics/img/cancel-on.png"/></label>
...
<script type="text/javascript" src="<%=path %>/statics/localjs/modifygoodspack.js"></script> 
