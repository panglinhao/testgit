...
<div>
	<ul class="breadcrumb">
		...
		<li><a href="/SLSaleSystem/backend/goodsinfolist.html">商品套餐管理</a></li>
	</ul>
</div>
<div class="row-fluid sortable">
	<div class="box span12">
		...
		<div class="box-content">
			<form action="/SLSaleSystem/backend/goodspacklist.html" method="post">
			...
			<div class="pagination pagination-centered">
				<ul>
					<c:choose>
						...
						<c:otherwise>
							<li><a
								href="/SLSaleSystem/backend/goodspacklist.html?currentpage=1&s_goodsPackName=${s_goodsPackName}&s_state=${s_state}&s_typeId=${s_typeId}"
								title="首页">首页</a></li>
						</c:otherwise>
					</c:choose>
					<c:if test="${page.prevPages!=null}">
						<c:forEach items="${page.prevPages}" var="num">
							<li><a
								href="/SLSaleSystem/backend/goodspacklist.html?currentpage=${num}&s_goodsPackName=${s_goodsPackName}&s_state=${s_state}&s_typeId=${s_typeId}"
					...
					<c:if test="${page.pageCount !=null}">
						<c:choose>
							...
							<c:otherwise>
								<li><a
									href="/SLSaleSystem/backend/goodspacklist.html?currentpage=${page.pageCount}&s_goodsPackName=${s_goodsPackName}&s_state=${s_state}&s_typeId=${s_typeId}"
									title="尾页">尾页</a></li>
							</c:otherwise>
						</c:choose>
					</c:if>
...
<script type="text/javascript" src="<%=path %>/statics/localjs/goodspacklist.js"></script>