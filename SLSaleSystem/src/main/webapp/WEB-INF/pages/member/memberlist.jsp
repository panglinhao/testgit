...
<div>
	<ul class="breadcrumb">
		...
		<li><a href="/SLSaleSystem/member/memberlist.html">新会员管理</a></li>
	</ul>
</div>
			...
			<div class="row-fluid sortable">		
				<div class="box span12">
					...
					<div class="box-content">
						<form action="/SLSaleSystem/member/memberlist.html" method="post">
					...
					<div class="pagination pagination-centered">
					  <ul>
					   <c:choose>
					  	...
					  	<c:otherwise>
					  	<li><a href="/SLSaleSystem/member/memberlist.html?currentpage=1&s_loginCode=${s_loginCode}&s_userName=${s_userName}" title="首页">首页</a></li>
					  	</c:otherwise>
					  </c:choose>
						
						<c:if test="${page.prevPages!=null}">
							<c:forEach items="${page.prevPages}" var="num">
								<li><a href="/SLSaleSystem/member/memberlist.html?currentpage=${num}&s_loginCode=${s_loginCode}&s_userName=${s_userName}"
						...
						<c:if test="${page.nextPages!=null}">
							<c:forEach items="${page.nextPages}" var="num">
								<li><a href="/SLSaleSystem/member/memberlist.html?currentpage=${num}&s_loginCode=${s_loginCode}&s_userName=${s_userName}" title="${num}">
								${num} </a></li>
							</c:forEach>
						</c:if>
						<c:if test="${page.pageCount !=null}">
							<c:choose>
						  	...
						  	<c:otherwise>
						  	<li><a href="/SLSaleSystem/member/memberlist.html?currentpage=${page.pageCount}&s_loginCode=${s_loginCode}&s_userName=${s_userName}" title="尾页">尾页</a></li>
						  	</c:otherwise>
						    </c:choose>
					    </c:if>
						<c:if test="${page.pageCount == null}">
	   ...
	   <div class="modal hide fade" id="modifyMemberDiv">
		<form action="/SLSaleSystem/member/modifymember.html" enctype="multipart/form-data" method="post" onsubmit="return modifyMemberFunction();">
			<div class="modal-header">
				<button type="button" class="close" data-dismiss="modal">×</button>
				<h3>修改会员信息</h3>
			</div>
...
<script type="text/javascript" src="<%=path %>/statics/localjs/memberlist.js"></script> 
