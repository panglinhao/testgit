...
<div>
	<ul class="breadcrumb">
		...
		<li><a href="/SLSaleSystem/member/registmember.html">会员注册</a></li>
	</ul>
</div>
			<div class="row-fluid sortable">		
				...
				<form action="/SLSaleSystem/member/saveregistmember.html" enctype="multipart/form-data" method="post" onsubmit="return registMemberFunc();">
...
<script type="text/javascript" src="<%=path %>/statics/localjs/registmember.js"></script> 