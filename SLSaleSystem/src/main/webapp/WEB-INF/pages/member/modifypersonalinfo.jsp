...
<div>
	<ul class="breadcrumb">
		...
		<li><a href="/SLSaleSystem/member/modifypersonalinfo.html">修改本人资料</a></li>
	</ul>
</div>
			<div class="row-fluid sortable">		
				...
				<form action="/SLSaleSystem/member/savepersonalinfo.html" enctype="multipart/form-data" method="post" onsubmit="return modifyPersonalInfoFunc();">
...
<script type="text/javascript" src="<%=path %>/statics/localjs/modifypersonalinfo.js"></script> 
