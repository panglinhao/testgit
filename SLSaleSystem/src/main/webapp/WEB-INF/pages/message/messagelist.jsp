...
<div>
	<ul class="breadcrumb">
		...
		<li><a href="/SLSaleSystem/message/messagelist.html">留言管理</a></li>
	</ul>
</div>
					...
					<div class="pagination pagination-centered">
					  <ul>
					   <c:choose>
					  	...
					  	<c:otherwise>
					  	<li><a href="/SLSaleSystem/message/messagelist.html?currentpage=1" title="首页">首页</a></li>
					  	</c:otherwise>
					   </c:choose>
						<c:if test="${page.prevPages!=null}">
							<c:forEach items="${page.prevPages}" var="num">
								<li><a href="/SLSaleSystem/message/messagelist.html?currentpage=${num}"
						...
						<c:if test="${page.nextPages!=null}">
							<c:forEach items="${page.nextPages}" var="num">
								<li><a href="/SLSaleSystem/message/messagelist.html?currentpage=${num}" title="${num}">
								${num} </a></li>
							</c:forEach>
						</c:if>
						<c:if test="${page.pageCount !=null}">
							<c:choose>
						  	...
						  	<c:otherwise>
						  	<li><a href="/SLSaleSystem/message/messagelist.html?currentpage=${page.pageCount}" title="尾页">尾页</a></li>
						  	</c:otherwise>
						    </c:choose>
					    </c:if>
						<c:if test="${page.pageCount == null}">
	 ...
	 <div class="modal hide fade" id="replyMessageDiv">
			...
			<ul id="replylist"></ul>
			<form action="/SLSaleSystem/message/replymessage.html" enctype="multipart/form-data" method="post" onsubmit="return replyMessageFunction();">
			<div class="modal-body">
...
<script type="text/javascript" src="<%=path %>/statics/localjs/messagelist.js"></script> 
