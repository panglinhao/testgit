...
<div>
	<ul class="breadcrumb">
		...
		<li><a href="/SLSaleSystem/informanage/information.html">资讯管理</a></li>
	</ul>
</div>
				...
				<div class="box span12">
					...
					<div class="pagination pagination-centered">
					  ...
					  <c:choose>
					  	...
					  	<c:otherwise>
					  	<li><a href="/SLSaleSystem/informanage/information.html?p=1" title="首页">首页</a></li>
					  	</c:otherwise>
					  </c:choose>
						
						<c:if test="${page.prevPages!=null}">
							<c:forEach items="${page.prevPages}" var="num">
								<li><a href="/SLSaleSystem/informanage/information.html?p=${num}"
						...
						<c:if test="${page.nextPages!=null}">
							<c:forEach items="${page.nextPages}" var="num">
								<li><a href="/SLSaleSystem/informanage/information.html?p=${num}" title="${num}">
								${num} </a></li>
							</c:forEach>
						</c:if>
						<c:if test="${page.pageCount !=null}">
							<c:choose>
						  	...
						  	<c:otherwise>
						  	<li><a href="/SLSaleSystem/informanage/information.html?p=${page.pageCount}" title="尾页">尾页</a></li>
						  	</c:otherwise>
						    </c:choose>
					    </c:if>
						<c:if test="${page.pageCount == null}">
	...
	<div class="modal hide fade" id="addInformationDiv">
		<form action="/SLSaleSystem/informanage/addInformation.html" enctype="multipart/form-data" method="post" onsubmit="return addInfoFunction();">
	 ...
	 <div class="modal hide fade" id="modifyInfoDiv">
		<form action="/SLSaleSystem/informanage/modifyinformation.html" enctype="multipart/form-data" method="post" onsubmit="return modifyInfoFunction();">
			<div class="modal-header">
				<button type="button" class="close addusercancel" data-dismiss="modal">×</button>
				<h3>修改资讯信息</h3>
			</div>
...
<script type="text/javascript" src="<%=path %>/statics/localjs/information.js"></script> 
