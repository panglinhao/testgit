...
<div>
	<ul class="breadcrumb">
		...
		<li><a href="/SLSaleSystem/informanage/downloadcenter.html">下载中心</a></li>
	</ul>
</div>
			<div class="row-fluid sortable">		
				<div class="box span12">
					...
					<form action="/SLSaleSystem/informanage/downloadcenter.html" method="post">
					...
					<div class="pagination pagination-centered">
					  <ul>
					   <c:choose>
					  	...
					  	<c:otherwise>
					  	<li><a href="/SLSaleSystem/informanage/downloadcenter.html?p=1&k=${k}" title="首页">首页</a></li>
					  	</c:otherwise>
					   </c:choose>
						<c:if test="${page.prevPages!=null}">
							<c:forEach items="${page.prevPages}" var="num">
								<li><a href="/SLSaleSystem/informanage/downloadcenter.html?p=${num}&k=${k}"
						...
						<c:if test="${page.nextPages!=null}">
							<c:forEach items="${page.nextPages}" var="num">
								<li><a href="/SLSaleSystem/informanage/downloadcenter.html?p=${num}&k=${k}" title="${num}">
								${num} </a></li>
							</c:forEach>
						</c:if>
						<c:if test="${page.pageCount !=null}">
							<c:choose>
						  	...
						  	<c:otherwise>
						  	<li><a href="/SLSaleSystem/informanage/downloadcenter.html?p=${page.pageCount}&k=${k}" title="尾页">尾页</a></li>
						  	</c:otherwise>
						    </c:choose>
					    </c:if>
						<c:if test="${page.pageCount == null}">
