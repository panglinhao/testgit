...
<head>
	<!--
		...
		http:/statics/www.apache.org/licenses/LICENSE-2.0

		http:/statics/usman.it
		http:/statics/twitter.com/halalit_usman
	-->
	<meta charset="utf-8">
	<title>SL会员商城</title>
	...
	<!--[if lt IE 9]>
	  <script src="http:/statics/html5shim.googlecode.com/svn/trunk/html5.js"></script>
	<![endif]-->
	...
	<div class="navbar">
		<div class="navbar-inner">
			<div class="container-fluid">
				...
				<a class="brand" href="main.html"> <img alt="Charisma Logo" src="<%=path%>/statics/img/logo20.png" /> <span>SL会员商城</span></a>
				...
				<div class="btn-group pull-right theme-container" >
					<ul class="nav">
						...
						<li><a href="/SLSaleSystem/main.html">首页</a></li>
						<li><a href="#">购物车</a></li>
						<li><a href="#">留言板</a></li>
						<li><a href="javascript:void();" class="btn-setting modifypwd">修改密码</a></li>
						<li><a href="/SLSaleSystem/logout.html">注销</a></li>
					</ul>
				</div>
